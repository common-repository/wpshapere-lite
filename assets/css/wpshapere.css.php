...
$admin_menu_width = ( isset($this->aof_options['admin_menu_width']) && !empty($this->aof_options['admin_menu_width']) ) ? $this->aof_options['admin_menu_width'] : '200';
  ...
  if(empty($this->aof_options['default_adminbar_height'])) {
    ...
    $css_styles .= '@media screen and (max-width: 782px){
      ...
      .woocommerce-layout__header{top: 46px;}
    }
    @media only screen and (min-width:782px) {
      html.wp-toolbar {padding-top: 50px;}
      #wpadminbar .quicklinks>ul>li>a, div.ab-empty-item { padding: 9px !important }
      .woocommerce-layout__header{top: 50px;width: calc(100% - '. $admin_menu_width .'px);}
    }
    .woocommerce-layout__header{margin-left:-30px}
    body[class*=page_aioseo].admin-bar #wpwrap .aioseo-header, body[class*=page_aioseo].admin-bar #wpwrap .aioseo-notifications .overlay, body[class*=page_aioseo].admin-bar #wpwrap .aioseo-notifications .notification-menu {
   top:50px }
   [dir=ltr] body[class*=page_aioseo] #wpwrap .aioseo-header, [dir=ltr] body[class*=page_aioseo] .aioseo-notifications .overlay {
...
$logo_l_margins = (isset($this->aof_options['logo_left_margin']) && !empty($this->aof_options['logo_left_margin']) ) ? $this->aof_options['logo_left_margin'] . 'px' : '12px';
